<template>
  <div class="text">
    ...
    <div class="form-group settings-group" v-if="!iOS">
      ...
      <div v-if="state.backgroundMode === 'image'" class="settings-info">
        ...
        <div v-else>
          ...
          Photo by
          <a
            :href="`${state.backgroundURL}?utm_source=chatlink&utm_medium=referral`"
            >{{ state.backgroundAuthor }}</a
          >
          on
          <a
            href="https://unsplash.com/?utm_source=chatlink&utm_medium=referral"
            target="_blank"
    ...
    <div class="release-info">
      <a href="https://chatlink.in" @click.prevent="showInfo = !showInfo">Powered by Chat Link</a>
      |
      <a
        href="/"
        target="_blank"
